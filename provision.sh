...
log "You should be able to access Monitor on:"
log "https://localhost:4436 (EL6) or https://localhost:4437 (EL7)."
...
printf "\n\n"
log "WARNING: You may get HSTS errors in some browsers. To work around this, "
log "set up the hostname of the box in your host file, or use another browser."